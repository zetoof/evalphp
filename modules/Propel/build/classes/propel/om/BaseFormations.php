...
/**
 * Base class that represents a row from the 'formations' table.
 *
 *
 *
 * @package    propel.generator.propel.om
 */
abstract class BaseFormations extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'FormationsPeer';
     ...
     * @return Formations The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FormationsPeer::ID;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = FormationsPeer::NOM;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = FormationsPeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = FormationsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Formations object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FormationsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FormationsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FormationsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FormationsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(FormationsPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(FormationsPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }

        $sql = sprintf(
            'INSERT INTO `formations` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FormationsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FormationsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Formations'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Formations'][$this->getPrimaryKey()] = true;
        $keys = FormationsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNom(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FormationsPeer::ID)) $criteria->add(FormationsPeer::ID, $this->id);
        if ($this->isColumnModified(FormationsPeer::NOM)) $criteria->add(FormationsPeer::NOM, $this->nom);
        if ($this->isColumnModified(FormationsPeer::DESCRIPTION)) $criteria->add(FormationsPeer::DESCRIPTION, $this->description);
    ...
    {
        $criteria = new Criteria(FormationsPeer::DATABASE_NAME);
        $criteria->add(FormationsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Formations (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Formations Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FormationsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FormationsPeer();
        }
     ...
     * If this Formations is new, it will return
    ...
    public function setSessionss(PropelCollection $sessionss, PropelPDO $con = null)
    {
        ...
        foreach ($sessionssToDelete as $sessionsRemoved) {
            $sessionsRemoved->setFormations(null);
        }
    ...
    {
        return (string) $this->exportTo(FormationsPeer::DEFAULT_STRING_FORMAT);
    }
